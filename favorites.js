/* favorites.js — personal saved rubbing comparisons.
 *
 ...
 * (key "epiwen_favorites"); no server round-trip. Shared by catalog.js (the
 * compare bar), viewer.html (the Save button), and favorites.html (the page).
 *
 * window.EpiFavorites:
